...
bool MovePart::get_part(int part_code) {
     ...
     object_finder_ac_.sendGoal(object_finder_goal_,
                        boost::bind(&MovePart::objectFinderDoneCb, this, _1, _2));
      ...
      //Do move to part:
    //CHANGE THIS: get coords x,y from object finder result
    geometry_msgs::PoseStamped perceived_object_pose = perceived_object_poses_[0]; //dumb...just picked first object found
